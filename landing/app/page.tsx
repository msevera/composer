        ...
        <div className="max-w-4xl mx-auto mt-16 md:mt-24">
          <div className="relative">
            ...
            <div className="relative bg-gray-900 rounded-2xl shadow-2xl shadow-black/50 border border-gray-800 overflow-hidden">
              ...
              <div className="flex p-6 md:p-8 h-[632px] md:h-[542px]">
                <div className="flex flex-1 items-start gap-4">
                  <div className="hidden md:flex self-start w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-pink-600 items-center justify-center text-white font-medium text-sm shrink-0 shadow-lg shadow-orange-900/20">
                    JD
                  </div>
                  <div className="flex flex-col flex-1 h-full">
                    <div className="flex items-center gap-4">
                      <div className="flex md:hidden self-start w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-pink-600 items-center justify-center text-white font-medium text-sm shrink-0 shadow-lg shadow-orange-900/20">
                        JD
                      </div>
                      <div>
