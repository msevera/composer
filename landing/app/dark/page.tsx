              ...
              <div className="p-6 md:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* AI Response */}
                    <div className="bg-gradient-to-br from-blue-900/20 to-violet-900/20 rounded-xl p-4 border border-blue-500/20">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm font-medium text-gray-300">AI Draft</span>
